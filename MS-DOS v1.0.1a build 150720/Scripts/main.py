...
for i in range(1232):
    ...
    if dosCMD == "dos":
        print("#################################MS-DOS#################################")
        print("\n\n\nMS-DOS Python dock v1.0a ID: 14.07.20\n\n\nPython Shell")
    if dosCMD == "dir a":
        drive = "A"
    if dosCMD == "dir A":
        drive = "A"
    ...
    if dosCMD == "reboot":
        ...
        notepadNotes[notepadInt] = notepadNotes[notepadInt].replace(str('\n'), "\n")
        ...
        print("Invalid command. If you believe this is in error, please contact Skoppai at Skoppai#3696 on discord.")